...
class ReferYouTubeVOSDataset(Dataset):
    ...
    def __init__(self, subset_type: str = 'train', dataset_path: str = '/mnt/data_16TB/lzy23/rvosdata/refer_youtube_vos', window_size=12,
        ...
        dataset_path = '/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_youtube_vos'
        if subset_type == 'test':
    ...
    def __getitem__(self, idx):
        ...
        if self.subset_type == 'train':
            with open(path.join('/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_youtube_vos/train', 'meta.json'), 'r') as f:
