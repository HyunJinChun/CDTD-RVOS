...
class A2DSentencesDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = '/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/a2d_sentences', window_size=8,
    ...
    def get_text_annotations(root_path, subset, distributed):
        saved_annotations_file_path = f'/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/a2d_sentences/a2d_sentences_single_frame_{subset}_annotations.json'
