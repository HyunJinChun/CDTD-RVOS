...
class ReferYouTubeVOSDataset(Dataset):
    ...
    def __init__(self, subset_type: str = 'train',
                 dataset_path: str = '/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_davis',
        ...
        dataset_path = '/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_davis'
        if subset_type == 'test':
    ...
    def generate_samples_metadata(self, dataset_path, subset_type, distributed):
        ...
        if path.exists(metadata_file_path):
            ...
            subset_expressions_file_path = path.join(dataset_path, 'meta_expressions', subset_type,
            ...
            with open(subset_expressions_file_path, 'r') as f:
                ...
                test_expressions_file_path = path.join(dataset_path, 'meta_expressions', 'test',
                                                       'meta_expressions.json')
    ...
    def __getitem__(self, idx):
        ...
        if self.subset_type == 'train':
            with open(
                    path.join('/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_youtube_vos/train',
                              'meta.json'), 'r') as f:
...
if __name__ == "__main__":
    dataset_path = "/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/ref-davis"
    subset_type = 'valid'
    distributed = False
