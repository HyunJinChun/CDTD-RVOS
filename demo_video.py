...
def main(config):
    ...
    save_dir = os.path.join('/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/outputs/video_demo', ver_dir)
    ...
    exp = "man in white shirt is shooting a ball to the basket" #"a man falls down suddenly"
