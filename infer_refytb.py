...
def main(config):
    ...
    if split == 'test':
        split = "valid"
    # save path
    save_dir = '/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/outputs'
    ...
    # load data
    root = "/mnt/34e3c0a7-f958-4422-baee-2ae895497e90/hyun_ws/SOC_Bi-CA/rvosdata/refer_youtube_vos"
